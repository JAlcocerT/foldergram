...
features:
  ...
  - title: Honest scope
    details: The current app includes feed browsing, explore, library, likes, moments, settings, and local maintenance controls without auth, cloud sync, or social features.
---
...
<p>The current repository includes Home, Explore, Library, Likes, Moments, Settings, folder pages, a post detail view and modal flow, local likes, delete actions, manual scans, full library rebuilds, and thumbnail-only rebuilds.</p>
</div>
...
<p>Settings includes manual scan, thumbnail rebuild, and full library rebuild actions so you can refresh the index and generated media without touching the source files by hand.</p>
</div>
